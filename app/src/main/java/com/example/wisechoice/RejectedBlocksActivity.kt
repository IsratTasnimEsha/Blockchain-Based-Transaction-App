...
class RejectedBlocksAdapter(
...
) : RecyclerView.Adapter<RejectedBlocksAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.block_card.setOnClickListener {
            ...
            intent.putExtra("path", "rejected_blocks")
...
class RejectedBlocksActivity : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener{

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapterClass: RejectedBlocksAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rejected_blocks)
        ...
        adapterClass = RejectedBlocksAdapter(
            this,
            ids,
            miners,
            no_of_transactionss,
